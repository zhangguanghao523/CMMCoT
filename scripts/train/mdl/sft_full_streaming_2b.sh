...
# deepspeed_config='examples/deepspeed/ds_z3_offload_config.json'

# vllm model
vllm="/mnt/workspace/xiaoxi/model_pretrained/qwen_lab/Qwen2-VL-2B-Instruct"

# output dir
output_dir="/mnt/workspace/xiaoxi/model_logs/model_cmmcot-2b_stage1"
run_name="${output_dir##*/}"
