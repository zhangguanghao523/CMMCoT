...
def _encode_supervised_example(
    ...
    messages, mm_inputs = template.mm_plugin.process_messages(prompt + response, images, videos, processor)
    ...
    for turn_idx, (source_ids, target_ids) in enumerate(encoded_pairs):
        ...
        if mask_history and turn_idx != 0:  # train on the last turn only
            ...
            target_label = [IGNORE_INDEX if x == 151655 else x for x in target_ids]
    ...
    return input_ids, labels, mm_inputs
...
def preprocess_supervised_dataset(
    ...
    for i in range(len(examples["_prompt"])):
        ...
        input_ids, labels, mm_inputs = _encode_supervised_example(
        ...
        model_inputs["mm_inputs"].append(mm_inputs)
